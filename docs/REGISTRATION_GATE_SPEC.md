...
> **Status em 2026-08-22:** concluído e validado localmente e no servidor real. Migration v21,
> Portaria Digital por painel/modal, revisão administrativa, integrações, página web, preview,
> snapshot e rollback foram entregues. A validação real confirmou 121 contas restritas, amostra de
> dez visitantes com acesso somente às áreas públicas autorizadas e zero vazamentos/unclassified.
> O token anteriormente exposto e as permissões excessivas do cargo do bot continuam sendo uma
> pendência humana do gate de segurança geral, não uma falha funcional desta fase.
