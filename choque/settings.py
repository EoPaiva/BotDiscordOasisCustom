...
class SettingsService:
    DEFAULTS: dict[str, Any] = {
        ...
        "activity_absence_alert_channel_id": None,
        ...
        "member_role_id": None,
        "special_unit_minimum_rank_level": 3,
        "special_units_recruitment_channel_id": None,
        "special_units_recruitment_category_id": None,
        "away_role_id": None,
