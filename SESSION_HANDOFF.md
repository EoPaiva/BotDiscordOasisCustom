...
## 0. Checkpoint mais recente — corte 25 da Fase 57 publicado

**Branch:** `main`. **TDD:** `057f3b1` registra o contrato RED e `8347a0f` entrega o GREEN. Ambos
foram enviados para `origin/main` e `private/main`.

**Entregue:** o formulário e os dois controles de filtro de `/officer-candidacies` agora possuem
nomes acessíveis. Parâmetros, busca, regex, URLs, APIs, RBAC, layout e regras permanecem iguais.

**Gates locais:** 1 teste focado; 100 testes em 26 arquivos; lint; typecheck; build;
`npm audit` sem vulnerabilidades; 8 E2E aprovados e 1 cenário visual Firefox intencionalmente
ignorado.

**Produção técnica:** deploy Vercel `dpl_GzivhujHQhE3YfMeczQQmawfUsDU`, `READY` em 2026-08-27,
...
bloqueada, a Fase 57 pode avançar localmente em cortes pequenos e fecháveis; vinte e cinco cortes do Centro
...
O protocolo de continuidade foi instalado na raiz. Depois, a Fase 57 avançou em vinte e cinco cortes do
...
perfil; `32b4bbf`/`a7314c6` cobrem o início do lockdown e as datas dos eventos de segurança; e
`057f3b1`/`8347a0f` nomeiam o formulário e os controles de filtro das candidaturas ao Oficialato.
...
Nenhuma alteração está em andamento. Transferências, os vinte e cinco cortes acessíveis da Fase 57 e o
...
- 1 teste focado dos filtros de candidaturas ao Oficialato passou.
- 100 testes Web passaram em 26 arquivos.
...
- [x] Fase 57 em candidaturas ao Oficialato: formulário, seletor de status e campo de responsável
  publicados com nomes acessíveis. TDD `057f3b1`/`8347a0f`; 100 testes web e gates completos verdes;
  deploy `dpl_GzivhujHQhE3YfMeczQQmawfUsDU` `READY` em 2026-08-27.
